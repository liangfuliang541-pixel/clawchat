...
export const registerHermesAgent = async (req, res, next) => {
    try {
...
export const listHermesAgents = async (_req, res, next) => {
    try {
...
export const triggerHermesAgent = async (req, res, next) => {
    try {
