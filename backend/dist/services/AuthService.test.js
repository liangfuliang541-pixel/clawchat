...
describe('AuthService', () => {
    ...
    describe('login', () => {
        it('should login with valid credentials', async () => {
            ...
            vi.mocked(userRepo.findByEmailWithPassword).mockResolvedValue(mockUser);
        ...
        it('should throw AuthenticationError if user not found', async () => {
            ...
            await expect(authService.login({ email: 'test@example.com', password: 'password123' })).rejects.toThrow(AuthenticationError);
        });
    });
    describe('getProfile', () => {
